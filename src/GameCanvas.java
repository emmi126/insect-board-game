...
public class GameCanvas extends Canvas {
    ...
    final static Color HIVE_COLOR = new Color(255,187,8);
    final static Color NEST_COLOR = Color.black;
    final static Color PATH_COLOR = Color.lightGray;
    final static Color BUSYBEE_COLOR = new Color(247,238,81);
    final static Color ANGRYBEE_COLOR = new Color(118,154,249);

    final static Color FIREBEE_COLOR = new Color(220,38,127);
    final static Color SNIPERBEE_COLOR = new Color(97,67,239);
    final static Color TANKYBEE_COLOR = Color.cyan;
    final static Color ON_FIRE_COLOR = new Color(243,122,47);
    final static Color GRASSLAND_COLOR = new Color(148,214,133);
